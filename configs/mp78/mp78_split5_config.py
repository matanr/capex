...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f'data/mp78_annotations_settingB/fixed_mp78_settingB_split5_train.json',
    ...
    val=dict(
        type='TransformerPoseDataset',
        ann_file=f'data/mp78_annotations_settingB/fixed_mp78_settingB_split5_test.json',
        img_prefix=f'{data_root}/images/',
        # img_prefix=f'{data_root}',
        data_cfg=data_cfg,
        valid_class_ids=None,
