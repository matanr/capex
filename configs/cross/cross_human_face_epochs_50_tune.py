...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f'{data_root}/cross_category_annotations/human_face_train.json',
    ...
    val=dict(
        type='TransformerPoseDataset',
        ann_file=f'{data_root}/cross_category_annotations/human_face_test.json',
        img_prefix=f'{data_root}/images/',
        # img_prefix=f'{data_root}',
        data_cfg=data_cfg,
        valid_class_ids=None,
